...
public class ThaumcraftCreativeCell {
    ...
    public static void createThaumcraftItemCell(EntityPlayer player) {
      ...
      //id[5]  = (short) getIdFromItem(ItemApi.getItem("itemCrystalEssence", 0).getItem());
        ...
        id[7]  = (short) getIdFromItem(ItemApi.getItem("itemManaBean", 0).getItem());
        id[8]  = (short) getIdFromItem(ItemApi.getItem("itemNugget", 0).getItem());
        id[9]  = (short) getIdFromItem(ItemApi.getItem("itemNuggetEdible", 0).getItem());
        id[10] = (short) getIdFromItem(ItemApi.getItem("itemTripleMeatTreat", 0).getItem());
        id[11] = (short) getIdFromItem(ItemApi.getItem("itemWispEssence", 0).getItem());
        id[12] = (short) getIdFromItem(ItemApi.getItem("itemZombieBrain", 0).getItem());
        id[13] = (short) getIdFromItem(ItemApi.getItem("itemThaumonomicon", 0).getItem());
